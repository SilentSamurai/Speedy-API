...
/**
 * Fluent builder for restoring (un-deleting) a soft-deleted entity by primary key.
 *
 * <pre>{@code
 * speedy.restore("User")
 *     .key("id", 123)
...
public class RestoreBuilder {
    ...
    public RestoreBuilder(String entity, PathBuilder paths, RequestSender sender,
    ...
    /**
     * Sets the primary key for the entity to restore.
     */
    public RestoreBuilder key(String field, Object value) {
        FieldUtil.setField(pkNode, field, value);
        return this;
    }

    /**
     * Executes the restore request and returns the result.
     *
     * @return SpeedyResult containing the restored entity(s)
    ...
    public SpeedyResult execute() {
        ...
        try {
            ...
            throw new SpeedyConnectionException("Restore request failed: " + e.getMessage(), e);
        }
    }
}
