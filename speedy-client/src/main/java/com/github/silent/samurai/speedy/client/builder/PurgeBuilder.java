...
/**
 * Fluent builder for permanently (hard) deleting an entity by primary key, bypassing soft delete.
 *
 * <pre>{@code
 * speedy.purge("User")
 *     .key("id", 123)
...
public class PurgeBuilder {
    ...
    public PurgeBuilder(String entity, PathBuilder paths, RequestSender sender,
    ...
    /**
     * Sets the primary key for the entity to purge.
     */
    public PurgeBuilder key(String field, Object value) {
        FieldUtil.setField(pkNode, field, value);
        return this;
    }

    /**
     * Executes the purge request and returns the result.
     *
     * @return SpeedyResult containing the purged entity(s)
    ...
    public SpeedyResult execute() {
        ...
        try {
            ...
            throw new SpeedyConnectionException("Purge request failed: " + e.getMessage(), e);
        }
    }
}
