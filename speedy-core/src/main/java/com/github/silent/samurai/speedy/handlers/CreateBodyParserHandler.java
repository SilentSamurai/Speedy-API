...
/// Parses the raw body of a $create request into a SpeedyCreateBody, using the
...
/// {@code SpeedyFactory.processReqV2}'s request-type switch, which routes CREATE here.
///
/// @see IRequestBodyParser
/// @see CreateHandler
public class CreateBodyParserHandler implements Handler {
    ...
    public void process(SpeedyContext context) throws SpeedyHttpException {
        ...
        SpeedyBody body = parser.parseCreate(rawBody,
