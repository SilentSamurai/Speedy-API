...
/// chain enforces its own toggle — mirroring {@link SpeedyActionCheckHandler}. Because PATCH
...
public class IsBulkEnableCheckHandler implements Handler {

    private final BulkOperation operation;

    public IsBulkEnableCheckHandler(BulkOperation operation) {
